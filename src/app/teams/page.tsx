...
import {Leads,TechCS,TechWD,EM,GT,OT,PR} from "@/components/teams/teams";
  ...
  return (
    <>
      ...
      <div className="relative z-10">
        ...
        <h1 className="font-gidugu text-6xl text-hero text-center mt-4">Event Management Team</h1>
        <ExpandableCard cards={EM}/>
        <h1 className="font-gidugu text-6xl text-hero text-center mt-4">Graphics Team</h1>
        <ExpandableCard cards={GT}/>
        <h1 className="font-gidugu text-6xl text-hero text-center mt-4">Outreach Team</h1>
